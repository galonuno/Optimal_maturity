...
years           = [0.5 1.5 2.5 3.5 4.5 5.5 6.5 7.5 8.5 9.5 10.5 11.5 12.5];
...
debt_data       = [5.7  13.07  8.68 7.1  6.79  5.93   8.20  7.22  6.84  5.38 4.93    2.52   3.01 ]; % This data comes from the Spanish Treasury, July 2018
...
% cd figures; 
% save Maturity_Profile; 
% saveas(gcf,'Maturity_Profile','pdf');
% cd ..
