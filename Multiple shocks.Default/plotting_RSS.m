...
plot([pre_t 0],[results.c_rss results.c_rss],'Linewidth',3,'Color',color2);
...
plot([pre_t 0],[Debt_rss Debt_rss]*100,'Linewidth',3,'Color',color2);
...
plot([pre_t 0],[average_duration(1) average_duration(1)],'Linewidth',3,'Color',color2);
...
plot([pre_t 0],[results.c_rss results.c_rss],'Linewidth',3,'Color',color4,'LineStyle',LineStyle_4);
...
plot([pre_t 0],[Debt_rss Debt_rss]*100,'Linewidth',3,'Color',color4,'LineStyle',LineStyle_4);
...
plot([pre_t 0],[average_duration(1) average_duration(1)],'Linewidth',3,'Color',color4,'LineStyle',LineStyle_4);
