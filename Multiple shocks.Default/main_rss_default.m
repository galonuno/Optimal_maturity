...
parameters.y_0(1:N_y,1)   = 1.0;%[0.99; 1.0; 0.95 ]; % [s*] initial value, output after a shock
parameters.rho_y(1:N_y,1) = 0.4;%[0.25; 0.45; 0.22]; % [s*] persistence output after shock - half life 1/rho months
...
parameters.r_bar_0(1:N_r,1)   = 0.04;%[0.06; 0.08]        ; % [s*] initial value [0.042 ; 0.043] 
...
parameters.penalty  = 0.05;        % Autarky penalty
